...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    try {
        const catRes = await fetch("https://admin.felnatech.com/home-menu");
    ...
    try {
        const [latest, popular, topRated] = await Promise.all([
            fetch("https://admin.felnatech.com/LatestProductList/getAllLatestProducts").then(res => res.json()),
            fetch("https://admin.felnatech.com/most-popular-product").then(res => res.json()),
            fetch("https://admin.felnatech.com/top-rated-product").then(res => res.json()),
        ]);
